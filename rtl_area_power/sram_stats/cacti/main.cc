...
//  g_tp.display();
  // Older CACTI code can crash during explicit teardown on modern toolchains.
  // The process exits immediately after reporting results, so let the OS
  // reclaim memory instead of risking a shutdown-time segfault.
  // result.cleanup();
