// =============================================================
// FP32 -> E2M* Quantizer (RNE, clamp to range, keeps signed zero)
// Parameters:
...
(
    ...
    // 取 M 位mantissa + RNE
    // 从 1.f23 中取： mant_M=f23[22 : 22-M+1]
    // guard=f23[22-M], sticky=OR(f23[22-M-1:0])
    wire [M-1:0] mant_M_pre = f23[22 -: M];
    ...
    wire         mant_carry     = mant_round_sum[M];
    wire [M-1:0] mant_M_rnd     = mant_round_sum[M-1:0];
