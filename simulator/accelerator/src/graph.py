...
from accelerator.src.tensor import Tensor
from accelerator.src.scalar.dtypes import Dtype, FQDtype, FixedPoint, Log, Binary, Float, CustomFloat
...
class Graph(object):
    ...
    def benchmark_tf(self, phase='forward+backward', csv_file='gpu_baseline.csv'):
        ...
        if len(r) == 0:
            ...
            from accelerator.src.tf_utils import get_tf_performance
