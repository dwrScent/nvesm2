...
from accelerator.src.utils.utils import lookup_pandas_dataframe
...
class SimulatorSweep(object):
    ...
    def sweep(self, sim_obj, list_n=None, list_m=None, list_pmax=None, list_pmin=None, list_bw=None, list_bench=None, list_wbuf=None, list_ibuf=None, list_obuf=None, list_batch=None, accelerator = None, weight_stationary = True):
        """
                                    ...
                                    for obuf in list_obuf:
                                        for bw in list_bw:
                                            ...
                                            for b in list_bench:
                                                ...
                                                nn = benchmarks.get_bench_nn(accelerator, b, batch_size)
...
def check_pandas_or_run(sim, dataframe, sim_sweep_csv, batch_size=1, config_file='./conf.ini', list_bench=None, accelerator='ant', weight_stationary = False):
    ld = {}
    ...
    if len(results) == 0:
        ...
        dataframe = sweep_obj.sweep(sim, list_bench=list_bench, list_batch=[batch_size], accelerator=accelerator, weight_stationary=weight_stationary)
